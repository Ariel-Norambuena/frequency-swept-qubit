...
conditions, and arbitrary-precision evaluation of Eq.~\eqref{M-eq:qWeber}.
...
in Eqs.~\eqref{M-eq:switchcoordinates}, \eqref{M-eq:lowerbirth},
\eqref{M-eq:tipcoordinates}, and \eqref{eq:rangecrossover}, and in
...
the sign-resolved energy balance in Eq.~\eqref{M-eq:energycounterexample}.
